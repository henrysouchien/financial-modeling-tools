...
# ruff: noqa: F401 - package facade intentionally re-exports imported names.

from . import _shared_slice as _shared_slice_module
from . import recommendations_shared_slice
from . import _uuid as ids
from ._public_api_exports import PUBLIC_SCHEMA_EXPORTS, SHARED_SLICE_DYNAMIC_EXPORTS
...
__all__ = list(PUBLIC_SCHEMA_EXPORTS)

for _shared_export_name in SHARED_SLICE_DYNAMIC_EXPORTS:
